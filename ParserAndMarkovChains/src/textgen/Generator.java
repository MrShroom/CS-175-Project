...
public class Generator {
	...
	public static void main(String [] args){
		...
		System.out.println(g.setCategory("Burgers").setStar(5).setReviewCount(1000).setNgramSize(3).train().generateReview());
		System.out.println();
		System.out.println(g.generateReview());
	}
}
